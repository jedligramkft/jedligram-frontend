...
const CommunitySidebar = ({ joinedUsernames, showAllMembers, onLoadMore, postsCount }: Props) => (
    ...
    <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-black/30 backdrop-blur">
      ...
      <div className="mt-4 space-y-3">
        {joinedUsernames.length === 0 ? (
          ...
          (showAllMembers ? joinedUsernames : joinedUsernames.slice(0, 5)).map((username, i) => (
    ...
    <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-xl shadow-black/30 backdrop-blur">
      ...
      <div className="mt-4 grid gap-3">
        <div className="rounded-2xl border border-white/10 bg-black/10 p-4">
          ...
          <div className="mt-1 text-2xl font-bold text-white">{joinedUsernames.length}</div>
        </div>
        <div className="rounded-2xl border border-white/10 bg-black/10 p-4">
