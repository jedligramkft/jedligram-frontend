			...
			<div className="relative z-10 mx-auto flex max-w-xl flex-col px-4 pt-12 pb-12">
				<div className="rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/30 backdrop-blur">
					...
					<p className="mt-2 text-sm text-white/70">
						Kezeld a fiókadataidat és személyes beállításaidat
					</p>
					...
					<div className="mt-10 grid gap-5">
						<div>
							...
							<input
								...
								className="mt-2 w-full rounded-xl border border-white/10 bg-white/10 px-4 py-3 text-sm text-white placeholder:text-white/50 outline-none focus:border-white/20"
							/>
						</div>
						...
						<div>
							...
							<textarea
								...
								className="mt-2 w-full resize-none rounded-xl border border-white/10 bg-white/10 px-4 py-3 text-sm text-white placeholder:text-white/50 outline-none focus:border-white/20"
							/>
						</div>
					</div>

					<div className="mt-8 flex items-center justify-between">
						<button className="text-sm font-semibold text-white/60 transition hover:text-white">
							Jelszó módosítása
						</button>
						<button
						...
						<button className="mt-2 rounded-xl bg-linear-to-r from-blue-500 to-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-md transition hover:from-blue-600 hover:to-blue-700">
							Mentés
						</button>
					</div>
				</div>
