	...
	return (
		<section className="w-full rounded-3xl border border-white/10 bg-white/5 p-6 text-white shadow-2xl shadow-black/30 backdrop-blur">
			...
			<p className="mt-2 text-sm text-white/70">
				Hozz létre fiókot a Jedligramhoz.
			</p>
			...
			<div className='mt-6 flex flex-col gap-3'>
				...
				<button type='button' onClick={handleRegister} className='mt-2 rounded-xl bg-linear-to-r from-blue-500 to-blue-600 px-4 py-3 text-sm font-semibold text-white keep-white shadow-md transition hover:from-blue-600 hover:to-blue-700'>Regisztráció</button>
			</div>
