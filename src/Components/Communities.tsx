...
const Communities = () => {
	...
	return (
		<section className="relative min-h-52 overflow-hidden bg-linear-to-b from-[#35383d] via-[#2b2f34] to-[#1f2226] poppins-regular">
						...
						visibleThreads.length === 0 && (
							<div className="md:col-span-2 lg:col-span-3 rounded-3xl border border-white/10 bg-white/5 p-8 text-center text-white/70 backdrop-blur">
								...
								<p className="mt-2 text-sm">
									{t("communities.no_results_description")}
								</p>
								<Link
									to="/all-communities"
									className="mt-5 inline-block rounded-full border border-white/20 px-6 py-3 text-sm font-semibold text-white transition hover:border-white/40 hover:bg-white/10"
								>
									{t("communities.view_all")}
								</Link>
							</div>
