    ...
    <div>
        <div className='bg-linear-to-b from-[#424549] to-[#2a2d31] md:min-h-175 min-h-175 flex items-center justify-center relative overflow-hidden poppins-regular'>
            ...
            <div className='text-center relative z-10 px-4'>
                <h1 className='md:text-4xl text-4xl font-black text-white mb-4 drop-shadow-lg'>Üdvözlünk a Jedligram oldalán!</h1>
                <p className='text-2xl text-gray-100 mt-4 font-medium drop-shadow-md mb-8'>Játék, közösség, és szórakozás egy helyen.</p>
                <div className='mt-8 flex justify-center gap-2 '>
                    <input type='text' placeholder='Keress csoportot...' className='md:w-200 sm:w-xs px-6 py-3 rounded-lg bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 flex-1' />
